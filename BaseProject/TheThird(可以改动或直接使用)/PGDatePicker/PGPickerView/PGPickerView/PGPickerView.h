...
@property(nonatomic, strong) UIColor *lineBackgroundColor;          // default is kColorWithHex(0x999999, 1)
@property (nonatomic, assign) CGFloat lineHeight;                   // default is 0.5

@property(nonatomic, strong) UIColor *verticalLineBackgroundColor; // default is kColorWithHex(0x999999, 1) type3 vertical line
...
@property (nonatomic, strong)UIColor *textColorOfOtherRow;        // default is kColorWithHex(0x999999, 1)
