...
- (void)startMonitoringReachabilityWithDefaultStyle:(BOOL)flag status:(void(^)(BaseRequestReachabilityStatus status))block {
    ...
    if (flag) {
        ...
        [Key_Window addSubview:notReachableLabel];
        [Key_Window bringSubviewToFront:notReachableLabel];
        notReachableLabel.hidden = YES;
        notReachableLabel.frame = CGRectMake(0, Status_Bar_Height, Screen_Width, 0);
            ...
            switch (status) {
                ...
                case AFNetworkReachabilityStatusNotReachable:
                {
                    ...
                    [UIView animateWithDuration:0.25 animations:^{
                        ...
                        notReachableLabel.frame = CGRectMake(0, Status_Bar_Height, Screen_Width, Navigation_Bar_Height - Status_Bar_Height);
                        [Key_Window layoutIfNeeded];
                    }];
                }
                    break;
...
- (AFHTTPSessionManager *)httpSessionManager {
    ...
    if (_httpSessionManager == nil) {
        ...
        _httpSessionManager = [[AFHTTPSessionManager alloc] initWithBaseURL:[NSURL URLWithString:Domain_Name] sessionConfiguration:[NSURLSessionConfiguration defaultSessionConfiguration]];
