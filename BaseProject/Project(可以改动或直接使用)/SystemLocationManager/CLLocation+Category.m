...
- (CLLocation *)transformLocationFromEarthToBaidu {
    ...
    CLLocation *tempMarsLocation = [self transformLocationFromEarthToMars];
    double lat = tempMarsLocation.coordinate.latitude;
    double lng = tempMarsLocation.coordinate.longitude;
