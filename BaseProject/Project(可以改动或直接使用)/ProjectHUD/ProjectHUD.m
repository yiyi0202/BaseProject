...
+ (void)showMBProgressHUDToView:(UIView *)view withText:(NSString *)text atPosition:(MBProgressHUDTextPosition)position completionHandlerAfterAutohide:(void(^)(void))completionHandler {
...
+ (void)updateMBProgressHUDOnView:(UIView *)view withRequstResult:(MBProgressHUDResult)result progressPrompt:(NSString *)prompt completionHandlerAfterAutohide:(void(^)(void))completionHandler {
